...
CREATE TABLE "User" (
    ...
    "image" TEXT,
    "passwordHash" TEXT,
    "role" "AppRole" NOT NULL DEFAULT 'PATIENT',
...
CREATE TABLE "CareAccess" (
    ...
    "status" "CareAccessStatus" NOT NULL DEFAULT 'ACTIVE',
    ...
    "canGenerateAIInsights" BOOLEAN NOT NULL DEFAULT false,
...
CREATE TABLE "CareInvite" (
    ...
    "email" TEXT NOT NULL,
    "accessRole" "CareAccessRole" NOT NULL,
    "status" "CareAccessStatus" NOT NULL DEFAULT 'PENDING',
    "token" TEXT NOT NULL,
...
CREATE TABLE "AiInsight" (
    ...
    "adherenceRisk" TEXT NOT NULL,
    "trendFlagsJson" TEXT NOT NULL,
    "suggestedQuestionsJson" TEXT NOT NULL,
    "recommendedFollowUpJson" TEXT NOT NULL,
