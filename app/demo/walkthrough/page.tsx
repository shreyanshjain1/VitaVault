...
const routeGroups = [
  ...
  },
  {
    ...
    links: [
      { label: "Notification Center", href: "/demo/notifications" },
      { label: "Care Plan", href: "/demo/care-plan" },
      { label: "Visit Prep", href: "/demo/visit-prep" },
      { label: "Emergency Card", href: "/demo/emergency-card" },
    ],
  },
  {
    ...
    links: [
      { label: "Health Trends", href: "/demo/trends" },
      { label: "Medication Safety", href: "/demo/medication-safety" },
      { label: "Lab Review", href: "/demo/lab-review" },
      { label: "Vitals Monitor", href: "/demo/vitals-monitor" },
      { label: "Symptom Review", href: "/demo/symptom-review" },
    ],
  },
  {
