import { BellRing, Pill, Stethoscope } from "lucide-react";
...
import { completeReminderAction, skipReminderAction } from "./actions";
      ...
      <div className="mx-auto max-w-7xl space-y-6 p-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription className="mt-1">
              Review upcoming items and update reminder lifecycle state.
            </CardDescription>
          </CardHeader>
